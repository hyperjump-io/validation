...
describe("JSON Validation", () => {
  ...
  describe("patternProperties validates properties matching a regex", () => {
    ...
    before(async () => {
      ...
      const doc = Hyperjump.get(testDomain + "/patternProperties-validation", Hyperjump.nil);
  ...
  describe("multiple simultaneous patternProperties are validated", () => {
    ...
    before(async () => {
      ...
      const doc = Hyperjump.get(testDomain + "/multiple-simultaneous-patternProperties", Hyperjump.nil);
      validate = await HVal.validate(doc);
    });
  ...
  describe("regexes are not anchored by default and are case sensitive", () => {
    ...
    before(async () => {
      ...
      const doc = Hyperjump.get(testDomain + "/regexes-not-anchored-and-not-case-sensitive", Hyperjump.nil);
      validate = await HVal.validate(doc);
    });
