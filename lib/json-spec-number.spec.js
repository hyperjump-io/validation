...
describe("JSON Schema", () => {
  describe("maximum validation", () => {
    ...
    before(async () => {
      ...
      const schema = await JsonSpec.get(testDomain + "/maximum-validation");
  ...
  describe("exclusiveMaximum validation", () => {
    ...
    before(async () => {
      ...
      const schema = await JsonSpec.get(testDomain + "/exclusive-maximum-validation");
      validate = await JsonSpec.validate(schema);
    });
  ...
  describe("minimum validation", () => {
    ...
    before(async () => {
      ...
      const schema = await JsonSpec.get(testDomain + "/minimum-validation");
      validate = await JsonSpec.validate(schema);
    });
  ...
  describe("exclusiveMinimum validation", () => {
    ...
    before(async () => {
      ...
      const schema = await JsonSpec.get(testDomain + "/exclusive-minimum-validation");
      validate = await JsonSpec.validate(schema);
    });
  ...
  describe("by int", () => {
    ...
    before(async () => {
      ...
      const schema = await JsonSpec.get(testDomain + "/by-int");
      validate = await JsonSpec.validate(schema);
    });
  ...
  describe("by number", () => {
    ...
    before(async () => {
      ...
      const schema = await JsonSpec.get(testDomain + "/by-number");
      validate = await JsonSpec.validate(schema);
    });
  ...
  describe("by small number", () => {
    ...
    before(async () => {
      ...
      const schema = await JsonSpec.get(testDomain + "/by-small-number");
      validate = await JsonSpec.validate(schema);
    });
