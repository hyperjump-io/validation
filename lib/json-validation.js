...
const _metaCompile = async (doc) => {
  ...
  await Promise.all(Object.entries(meta)
    ...
    .map(async ([keyword, _]) => {
      const keywordUrl = meta[keyword];
      //console.log(keywordUrl, keywords[keywordUrl]);
...
keywords["http://validation.hyperjump.io/common/const"] = {
  validation: {},
  compile: async (doc) => jsonStringify(value(doc)),
  interpret: (constValue, value) => jsonStringify(value) === constValue
};

keywords["http://validation.hyperjump.io/common/type"] = {
  validation: {
...
keywords["http://validation.hyperjump.io/common/multipleOf"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "number"
  },
...
keywords["http://validation.hyperjump.io/common/maximum"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "number"
  },
...
keywords["http://validation.hyperjump.io/common/exclusiveMaximum"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "number"
  },
...
keywords["http://validation.hyperjump.io/common/minimum"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "number"
  },
...
keywords["http://validation.hyperjump.io/common/exclusiveMinimum"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "number"
  },
...
keywords["http://validation.hyperjump.io/common/maxLength"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "number"
  },
...
keywords["http://validation.hyperjump.io/common/minLength"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "number"
  },
...
keywords["http://validation.hyperjump.io/common/pattern"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "string"
  },
...
keywords["http://validation.hyperjump.io/common/items"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "object",
    "validation": true
...
keywords["http://validation.hyperjump.io/common/tupleItems"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "array",
    "items": {
...
keywords["http://validation.hyperjump.io/common/maxItems"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "number",
    "minimum": 0,
...
keywords["http://validation.hyperjump.io/common/minItems"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "number",
    "minimum": 0,
...
keywords["http://validation.hyperjump.io/common/uniqueItems"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "boolean"
  },
...
keywords["http://validation.hyperjump.io/common/properties"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "object",
    "patternProperties": {
...
keywords["http://validation.hyperjump.io/common/patternProperties"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "object",
    "patternProperties": {
...
keywords["http://validation.hyperjump.io/common/propertyNames"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "object",
    "validation": true
...
keywords["http://validation.hyperjump.io/common/maxProperties"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "number",
    "minimum": 0,
...
keywords["http://validation.hyperjump.io/common/minProperties"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "number",
    "minimum": 0,
...
keywords["http://validation.hyperjump.io/common/required"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "array",
    "items": {
...
keywords["http://validation.hyperjump.io/common/allOf"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "array",
    "items": {
...
keywords["http://validation.hyperjump.io/common/anyOf"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "array",
    "items": {
...
keywords["http://validation.hyperjump.io/common/oneOf"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "array",
    "items": {
...
keywords["http://validation.hyperjump.io/common/not"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "object",
    "validation": true
...
keywords["http://validation.hyperjump.io/common/definitions"] = {
  validation: {
    "$meta": { "$ref": "http://validation.hyperjump.io/common" },
    "type": "object",
    "patternProperties": {
...
keywords["http://validation.hyperjump.io/common/validation"] = {
  validation: {},
  compile: async (doc) => {
    const meta = await _metaCompile(doc);
