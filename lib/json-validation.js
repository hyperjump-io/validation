...
const map = (doc, options = {}) => {
  const defaultHeaders = { "Accept": "application/validation+json" };
  const validationOptions = { ...options, headers: { ...defaultHeaders, ...options.headers } };
  return JsonReference.map(doc, validationOptions);
};
...
module.exports = { nil, source, value, pointer, get, map, entries, validate, contentType, contentTypeHandler };
